    ...
    <Grid className={classes.warningContainer} style={{ display: showModal ? 'flex' : 'none' }}>
      <Grid className={classes.warningBlock}>
        <Typography component='p'>
          <img src={icons.exclamation}></img>
        </Typography>
        <Typography component='h1' className={classes.warningHeader}>
          You have less than 0.05 SOL in your wallet!
        </Typography>
        <Typography component='p' className={classes.warningText}>
          {' '}
          Be aware that your transactions might fail because of having not enough funds for network
          fees.
        </Typography>
        <Button
