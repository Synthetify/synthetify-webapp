        ...
        <Grid item className={classes.exchange}>
          ...
          <Grid container className={classes.row}>
            <Grid item className={classes.plotWrapper}>
              <SwapInfo
                syntheticSymbol={
                  pairs[pairIndex === null ? 0 : pairIndex]?.syntheticData?.symbol ?? ''
                }
                collateralSymbol={
                  pairs[pairIndex === null ? 0 : pairIndex]?.collateralData?.symbol ?? ''
                }
                ...
                limit={
                  +printDecimal(pairs[pairIndex === null ? 0 : pairIndex]?.limit ?? decimalZero)
                }
              />
            </Grid>
            <WrappedSwaplineComponent pairs={pairs} onSelectPair={setPairIndex} />
          </Grid>
        </Grid>
      </Grid>
    </Fade>
