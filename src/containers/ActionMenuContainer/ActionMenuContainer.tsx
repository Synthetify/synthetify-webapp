  ...
  return (
    <WrappedActionMenu
      ...
      stakingData={{
        ...userStakingState,
        slot: slotState,
        currentRoundStartSlot: stakingState.currentRound.start,
        nextRoundStartSlot: stakingState.nextRound.start,
        finishedRoundStartSlot: stakingState.finishedRound.start,
